...
tc = struct( ...        %% test cases
        'name', {'1', '2'}, ...
        'ec', { @nme_gizmo_acc, ...
                {   {@nme_gen_acc_nln, 'nme_gen'}, ...
                    {@nme_load_acc_nln, 'nme_load'}, ...
                    {@nme_branch_acc_nln, 'nme_branch'}, ...
                    {@nme_shunt_acc_nln, 'nme_shunt'}, ...
                    @nme_gizmo_acc_nln }    } ...
    );
...
for c = 1:length(tc)
    ...
    dm = mp_data_mpc2().modify_element_classes(@dme_gizmo_mpc2).build(casefile, dmc);
    mpc = dm.mpc;
