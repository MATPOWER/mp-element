...
%     end     %% properties
    ...
    methods
        ...
        function obj = mp_data_mpc2_node_test()
            ...
            obj@mp_data_mpc2();
%             obj.element_classes = ...
%                 { @dme_bus_ld_mpc2_node_test, @dme_gen_mpc2_node_test, @dme_load_mpc2, ...
%                     @dme_branch_mpc2_node_test, @dme_shunt_mpc2 };
            obj.element_classes = ...
                { @dme_bus_ld_mpc2_node_test, @dme_gen_mpc2_node_test, ...
