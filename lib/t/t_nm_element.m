...
t_ok(strcmp(dc.form_name, 'DC formulation'), [t 'formulation name']);
...
t_ok(strcmp(nme{k}.find_form_class(), 'mp_form_dc'), [t 'formulation class']);
t_ok(strcmp(nme{k}.form_name, 'DC formulation'), [t 'formulation name']);
...
t_ok(strcmp(ac.form_name, 'AC-polar formulation'), [t 'formulation name']);
...
t_ok(strcmp(nme{k}.find_form_class(), 'mp_form_acp'), [t 'formulation class']);
t_ok(strcmp(nme{k}.form_name, 'AC-polar formulation'), [t 'formulation name']);
