...
t_ok(strcmp(dc.find_model_class(), 'mp_form_dc'), [t 'model class']);
...
t_ok(strcmp(nme{k}.find_model_class(), 'mp_form_dc'), [t 'model class']);
...
t_ok(strcmp(ac.find_model_class(), 'mp_form_acp'), [t 'model class']);
...
t_ok(strcmp(nme{k}.find_model_class(), 'mp_form_acp'), [t 'model class']);
