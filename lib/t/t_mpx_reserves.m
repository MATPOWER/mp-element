...
tsk = run_opf(casefile, mpopt, 'mpx', mpx_reserves, 'print_fname', fname_g);
rg = tsk.dm.elements.reserve_gen.tab;
rz = tsk.dm.elements.reserve_zone.tab;
t_ok(tsk.success, [t 'success']);
...
fname_e = fullfile(pathstr, 'pretty-printing', sprintf('%s.txt', fname));
fname_g = sprintf('%s_%d.txt', fname, rn);
tsk = run_opf(mpc, mpopt, 'mpx', mpx_reserves, 'print_fname', fname_g);
rg = tsk.dm.elements.reserve_gen.tab;
rz = tsk.dm.elements.reserve_zone.tab;
t_ok(tsk.success, [t 'success']);
...
tsk = run_opf(mpc, mpopt, 'mpx', mpx_reserves);
rg = tsk.dm.elements.reserve_gen.tab;
rz = tsk.dm.elements.reserve_zone.tab;
t_ok(tsk.success, [t 'success']);
