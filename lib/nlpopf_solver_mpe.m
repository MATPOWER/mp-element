...
%         bus(mm.userdata.veq, MU_VMAX) = mu_Vmax;
%         bus(mm.userdata.veq, MU_VMIN) = mu_Vmin;
%     end
%     bus(mm.userdata.viq, MU_VMAX) = lambda.ineqnonlin(nni.i1.Vmax:nni.iN.Vmax);
%     bus(mm.userdata.viq, MU_VMIN) = lambda.ineqnonlin(nni.i1.Vmin:nni.iN.Vmin);
% else
